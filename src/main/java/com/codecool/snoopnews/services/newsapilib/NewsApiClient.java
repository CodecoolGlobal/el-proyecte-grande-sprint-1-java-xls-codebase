package com.codecool.snoopnews.services.newsapilib;

import com.codecool.snoopnews.services.newsapilib.models.request.EverythingRequest;
import com.codecool.snoopnews.services.newsapilib.models.request.SourcesRequest;
import com.codecool.snoopnews.services.newsapilib.models.request.TopHeadlinesRequest;
...
import com.codecool.snoopnews.services.newsapilib.network.*;
...
//    private APIClient apiClient;
    ...
    public NewsApiClient(String apiKey, APIClient apiClient){
        this.apiKey = apiKey;
    ...
    public void getTopHeadlines(TopHeadlinesRequest topHeadlinesRequest, final ArticlesResponseCallback callback){
        ...
        apiService.getTopHeadlines(query)
    ...
    public void getEverything(EverythingRequest everythingRequest, final ArticlesResponseCallback callback){
        ...
        apiService.getEverything(query)
                .enqueue(new Callback<ArticleResponse>() {
                    @Override
                    public void onResponse(Call<ArticleResponse> call, retrofit2.Response<ArticleResponse> response) {
                        if (response.code() == HttpURLConnection.HTTP_OK){
